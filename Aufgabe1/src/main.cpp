...
int InsertLine( vector<string> &stringVec, vector<string>::iterator &it, 
               string newString, unsigned int aktLine, int newFile );

int DeleteLine( vector<string> &stringVec, vector<string>::iterator &it, 
               unsigned int aktLine );

int SearchString( vector<string> &stringVec, vector<string>::iterator &it, 
                 string newString, unsigned int aktLine );
